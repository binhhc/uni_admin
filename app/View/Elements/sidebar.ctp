    ...
    <ul id="nav">
        ...
        <li>
            <?php
            	...
            	echo $this->Html->link('<i class="fa fa-pencil"></i> <span>給与精算</span>', array('controller' => 'UnitPrices', 'action' => 'index'), array('escape' => false, 'class'=>$unitPrice)); 
            ?>
        </li>
        <li>
            <?php
            	...
            	echo $this->Html->link('<i class="fa fa-money"></i> <span>年収精算</span>', array('controller' => 'AnnualIncomes', 'action' => 'index'),array('escape' => false, 'class'=>$annual)); 
            ?>
        </li>                
        <li>
            <?php
            	...
            	echo $this->Html->link('<i class="fa fa-qrcode"></i> <span>教育履歴</span>', array('controller' => 'SchoolEducations', 'action' => 'index'),array('escape' => false, 'class'=>$school)); 
            ?>
        </li>                
        <li>
            <?php
            	...
            	echo $this->Html->link('<i class="fa fa-adjust"></i> <span>職種履歴</span>', array('controller' => 'WorkExperiences', 'action' => 'index'),array('escape' => false, 'class'=>$work)); 
            ?>
        </li>
        <li>
            <?php
