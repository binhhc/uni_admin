<?php echo $this->Form->create('UserInfo', array('class'=>'form-horizontal')) ?>
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('employee_id', array('class'=>'span4','label' => false, 'type' => 'text', @$readonly)); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('employee_name', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('employee_name_furigana', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('employee_name_alphabet', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('office_email', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('gender_code', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('sex', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('age', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('employment_type', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('zip_code', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('adjust_salary', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('prefecture', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('ward', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('address', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('building', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('job_cd', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('job', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('position_cd', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('work_location_cd', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('work_location', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('department_cd', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('department', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('problem_type_cd', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('problem_type', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('problem_grade', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('problem_content', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('recruit_type_cd', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('recruit_type', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('recruit_place_cd', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('recruit_place', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('introduction_type_cd', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('introduction_type', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('introduction_person', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('introduction_related_cd', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('introduction_related', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('face_auth_cd', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('face_auth', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('rating_job_cd', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('rating_job', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('rating_grade_cd', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('rating_grade', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>                        
