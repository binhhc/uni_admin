<?php echo $this->Html->link('Add', array('controller' => 'UnitPrices', 'action' => 'add')) ?>
        ...
        <?php if (empty($unitPrice)) { ?>
            ...
            foreach ($unitPrice as $price):
                ...
                <tr>                             
                    ...
                    <td class=""><?php echo $price['UnitPrice']['revise_date']; ?></td>
                    <td class=""><?php echo $price['UnitPrice']['salary_type']; ?></td>
                    <td class=""><?php echo $price['UnitPrice']['support_allowance']; ?></td>
                    <td class=""><?php echo $price['UnitPrice']['adjust_salary']; ?></td> 
                    <td class=""><?php echo $price['UnitPrice']['address_allowance']; ?></td>
