<?php echo $this->Form->create('UnitPrice', array('class'=>'form-horizontal')) ?>
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('employee_id', array('class'=>'span4','label' => false, 'options' => $user_info,'type' => 'select', @$readonly)); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('salary_type_cd', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('salary_type', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('bonus', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('support_allowance', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('leader_allowance', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('meal_allowance', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('address_allowance', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('absent_salary_cut', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('late_salary_cut', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('overtime_normal', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('overtime_night', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('overtime_holiday', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('overtime_1', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('overtime_2', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('overtime_3', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('overtime_4', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('overtime_5', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('basic_bonus', array('class' => 'span4', 'label' => false, 'type' => 'text')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('note', array('class' => 'span4', 'label' => false, 'type' => 'area', 'rows'=> 5, 'cols'=>30)); ?>
            </div>
        </div>
